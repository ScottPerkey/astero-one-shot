...
for mass in ${masses[*]}; do
	...
	for j in ${!alphas[@]}; do
	    echo $mass
	    ~/t2m.sh "/home/zinn/mesa/nonad/nonad_${mass}msun_${fehs[$i]}feh_mass_loss_${alphas[$j]}alpha_extend/LOGS/history.data" history_${count}.data
	    ~/t2m.sh "/home/zinn/mesa/nonad/nonad_${mass}msun_${fehs[$i]}feh_mass_loss_${alphas[$j]}alpha_extend/LOGS/profiles.index" profiles_${count}.index
	    ~/t2m.sh "/home/zinn/mesa/nonad/nonad_${mass}msun_${fehs[$i]}feh_mass_loss_${alphas[$j]}alpha_extend/LOGS/ad_approx_rad_err.dat" ad_approx_rad_err_${count}.dat
