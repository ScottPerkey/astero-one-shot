...
alphas=( 1.7 2.0 )
count=24 # use count = 0 for the 1.0 and 1.2 masses, but count=24 for 1.4 1.8 and 2.2.
cd /Users/jzinn/nonad/src/nonad/data/
if [[ count == 0 ]]; then
...
for mass in ${masses[*]}; do
	...
	for j in ${!alphas[@]}; do
	    ...
	    ~/t2m.sh "/home/zinn/mesa/nonad/nonad_${mass}msun_${fehs[$i]}feh_mass_loss_${alphas[$j]}alpha/LOGS/ad_approx_rad_err.dat" ad_approx_rad_err_${count}.dat
